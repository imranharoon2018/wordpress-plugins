...
function order_processing_email_template($order_id,$artist_email,$artist_comission,$order_item_ids,$order_item_exists){
	$sum_subtotal = 0.0;
	$order_items= array();
                                          ...
                                          <td valign="top">
											 ...
											 <div style="min-height:10pxfont-size:13px;line-height:22px;font-family:Helvetica,Roboto,Arial,sans-serif;;color:#000000">
													...
													<p style="padding-top:10px;padding-bottom:30px;">
														<span tyle="font-size:14px">You have received the following order:</span>
													</p>
												</div>
												...
												<?php 
													...
													if($order_item_exists[$item_id] && $product != null & is_object($product)){
														$sum_subtotal  +=  $order->get_line_subtotal($item,false);
